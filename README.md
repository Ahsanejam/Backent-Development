...
# Today Date i will add new file in repo this the homework file...
------------------------------------------------------------------------------
...
and I also learn about the schema structure and the constraints how to define it maxLenght of string and the number etc
